...
/* ═══════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════ */
/* ── 核心技巧（2026-09-04 老師拍板架構：影響力溝通 > 2 核心技巧 > 4 大肌肉 > 12 小肌肉 > 無數技巧）
   講故事、問問題＝共通心法——這 2 個用得好，後面 12 塊小肌肉才用得好。
   體驗客只給這 2 個輪流練；會員＝這 2 個＋主力大肌肉的 3 個技巧。
   腳本由 Claude 擬稿、老師有否決權；真相日後補進 productkit 秘訣庫（36→38 格）。 */
var CORE_DRILL = {
  story: {
    n: "講故事",
    h: "把想講的**道理**，換成**一件發生過的事**講出來。",
    who: "今天任何一個你想讓他懂一件事的人——家人、同事、客戶都行。",
    lead: "想講道理的那一刻先忍住，改講一件真的發生過的事：",
    line: "我跟你說一件事——之前有一次＿＿（發生什麼），後來＿＿（結果是）。",
    key: "故事要有人、有畫面、有轉折。道理不用你說，讓他自己從故事裡撿走。",
    win: "他聽完自己講出你想講的那個道理，或接著講起**他自己的故事**——就成了。",
    retry: "他聽完沒感覺？通常是故事太籠統——換一件更小、更具體、有畫面的事再講一次。"
  },
  ask: {
    n: "問問題",
    h: "今天忍住一次「給答案」，改**問一個問題**。",
    who: "任何來找你聊、跟你抱怨、問你意見的人。",
    lead: "他講完，先不要急著給建議，把嘴邊那句答案換成問句：",
    line: "後來呢？那你自己是怎麼想的？",
    key: "問完就安靜，讓他講。你話越少，他挖得越深。",
    win: "他越講越多、講到**自己找到答案**——話匣子是他的，就成了。",
    retry: "他只回一兩個字？從他剛講過的話裡挑一個詞，問下去就好。"
  }
};
