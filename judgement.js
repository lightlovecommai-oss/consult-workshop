...
var JUDGEMENT = {
  ...
  A3: {
    ...
    homework: "打造牛肉庫（5 類）；練一個低→轉→高的故事，30 秒講得完。",
    opener: "如果對方要跟別人介紹你，他會怎麼說？",
    evidence: "有沒有人轉述過你講的哪一段？"
  },
  T1: {
    symptom: "對話裡大部分是你在講；或對方一講問題你就急著給建議。",
    homework: "用皮肉骨 3 層提問，把對方在意的點**說回去**給他聽。",
    opener: "最近一次有人跟你說「你怎麼知道」，是什麼時候？",
    evidence: "當時你說了什麼讓他有這個反應？"
  },
  T2: {
    symptom: "談話很客氣但停在表面，對方不會跟你講真話。",
    homework: "講出心裡 OS 一次；講完再邀對方講出他的 OS。",
    opener: "你跟客戶講話的時候，有多少是真的你？",
    evidence: "上次你講出真心話，對方的反應是什麼？"
  },
  T3: {
    symptom: "答應的事會拖或忘記；也沒有讓人持續看見你的累積。",
    homework: "檢視這個月答應的事有沒有兌現；盤點你的 7-11-4（深度／頻率／場域）。",
  ...
  P2: {
    symptom: "講完專業對方說「聽起來不錯」，但沒有下一步。",
    homework: "找出你的大絕招，用 3 步跑一次（創造對比→帶入情境→收 0–10 分回饋）。",
    opener: "有沒有一個東西，你一做出來對方就秒懂你很懂？",
    evidence: "上次做給誰看過？他的反應是什麼？"
  },
  P3: {
    symptom: "只能講結論，講不出「怎麼做到」的步驟；對方聽完仍不確定有沒有用。",
    homework: "把你的服務做成 3–4 步驟的視覺化 Demo。",
    opener: "你的服務如果要畫成一張圖，會長什麼樣？",
    evidence: "有沒有畫給客戶看過？"
  },
  I1: {
