/* ═══════════════════════════════════════════════════════════
   ...
   🔄 2026-08-30 ATPI 重構同步：T 整組換內容（T1＝講出心裡 OS＝我先給／T2＝提問式聆聽・預看＝他才給／
      ...
      牛肉庫 A3→A2、7-11-4 退場。命名兩案未決，此表用格碼＋症狀敘述、不硬綁格名。
...
var JUDGEMENT = {
  ...
  T2: {  /* 讓他交心／請他交心＝提問式聆聽・邀請講OS／預看（他才給） */
  ...
  T3: {  /* 讓他當真／說到做到＝承諾兌現（我兌現，7-11-4 已退場） */
  ...
  P2: {  /* 讓他有感／親自實證＝大絕招 3 步・視覺化 Demo（自證·我作證） */
  ...
  I3: {  /* 讓他答應／邀他行動＝真誠邀請・被動跟進（留心已併入被動跟進） */
