...
var STRONG_PATH = {
  A: "你一開口，人會轉過來看你。有人追問「然後呢？」，有人默默記住了你。\n\n這是你身上最現成的力量：吸引。你不用更大聲，也不用更用力，人自然想靠近你。\n\n用在哪最有感：任何你想被聽見的場合——會議上發言、台上分享、第一次見面。你的起手式比別人省力。",
  T: "你跟人聊著聊著，對方會把沒跟別人說過的事說給你聽，講完還說「跟你講很舒服」。\n\n這是你身上最現成的力量：信任。你不用刻意追問，人自己就願意把真心話交出來。\n\n用在哪最有感：需要別人講真話的場合——一對一深談、帶人、處理家裡一直沒說開的事。別人卡住的地方，你一開始就在裡面了。",
  P: "你講完一段話，對方會沉默幾秒，然後說「你怎麼看得這麼清楚」，接著把問題丟給你。\n\n這是你身上最現成的力量：專業。你能把一團亂的事，講到對方心裡有底。\n\n用在哪最有感：別人拿不定主意的時候——同事來問你意見、對方問你該怎麼辦、台下有人卡了很久。你的一句話能省他三個月。",
  I: "你說完一段話，對方會當場說「好，那就這樣」，而不是「我再想想」。\n\n這是你身上最現成的力量：推進。你能讓人從點頭，變成真的動起來。\n\n用在哪最有感：事情老是停在原地的時候——會議結論沒人執行、家人講了三年都沒改、對方一直說再看看。你在，事情就會有下一步。"
};

/* ── 強項組合 → 你的影響力長什麼樣（依最強兩維度組合查表）──
   2026-09-08 老師拍板整批重寫（同 WEAK_DESC 那一輪的理由，這裡更嚴重）：
   舊版六組全是商業模式框架（客單價／收單／流量／B2B／轉介紹成交），三個問題——
   ①與 0907「quiz 訴求改影響力」牴觸 ②選「職場與家人」場景的人讀了會走錯棚
   ③整份都是皮層句，違反骨層三問第 2 問。
   新版紀律：場景中立（職場與家人／一對一銷售／一對多演講都讀得下去）、
   標題講影響力風格不講商業模式、tips 用「還沒跟上」不用「弱」（赤字語言禁用）。 */
var COMBO_PATH = {
  AT: {
    title: "先被看見，再被聽見真心話",
    flow: "① 你出現在一個場合，人自然注意到你\n② 聊起來之後，對方願意講真的\n③ 講著講著，他自己說出他的難處\n④ 你還沒給建議，他已經覺得被理解了",
    tips: "專業還沒跟上 → 別急著給方法，你的強項是陪他把事情講清楚\n推進還沒跟上 → 不用逼他決定，改成約下一次：「我們下週再聊聊？」\n這組合最怕只停在聊得很開心，記得替對話留一個下一步"
  },
  AP: {
    title: "一開口就被看見，講完就被當成內行",
    flow: "① 你一開口，話題自然往你這邊靠\n② 你講的東西有料，別人聽得懂也記得住\n③ 有人開始拿問題來問你\n④ 他心裡把你歸到「這件事要問他」那一格",
    tips: "信任還沒跟上 → 常出現本身就是一種信任，不用每次都深聊\n推進還沒跟上 → 講完加一句「你要不要先試這一步？」，把話變成動作\n這組合最怕講得漂亮但沒有下文，記得替對方指一個起點"
  },
  AI: {
    title: "抓得住人，也帶得動人",
    flow: "① 你一出現，注意力就過來了\n② 你講的話有溫度也有節奏，大家跟著你走\n③ 你在對的時機說「那我們就這樣做」\n④ 現場真的有人動起來",
    tips: "信任還沒跟上 → 讓別人的故事替你說話，比你自己保證更有力\n專業還沒跟上 → 講你真的做過的事，不用背方法論\n這組合最怕熱度過了就散，記得留一個隔天還在的東西：一句話，或一個約定"
  },
  PT: {
    title: "他敢跟你說真話，你能給他真答案",
    flow: "① 對方願意把真正的狀況說給你聽\n② 你聽得懂，也點得出他自己沒看到的地方\n③ 他說「對，就是這個」\n④ 之後遇到事，他第一個想到你",
    tips: "吸引還沒跟上 → 不用去人多的地方硬撐，讓認識你的人把你介紹出去\n推進還沒跟上 → 聊到最後問一句「那你打算先做哪一件？」，讓他自己說出來\n這組合最怕只有少數人知道你有多好，記得讓好口碑走得出去"
  },
  IT: {
    title: "他信你，所以你說動就動",
    flow: "① 對方本來就相信你這個人\n② 你聽懂他真正在乎的是什麼\n③ 你在結尾自然說出下一步，不拖\n④ 他答應了，而且真的去做",
    tips: "吸引還沒跟上 → 不用自己開場，去別人的場子露臉、被介紹進去\n專業還沒跟上 → 用實際發生過的結果說話，比講理論有力\n這組合最怕圈子就這麼大，記得讓做出來的結果被更多人看見"
  },
  IP: {
    title: "講得清楚，也收得了尾",
    flow: "① 你把複雜的事，講到對方聽得懂\n② 他覺得「這個人真的懂」\n③ 你直接說出他該做的下一步\n④ 事情當場定案，不用等他回去想",
    tips: "吸引還沒跟上 → 用整理好的資料和實例替你開路，不必靠個人魅力\n信任還沒跟上 → 準時、說到做到、回得快，這些會長成信任\n這組合最怕對方覺得有壓力，記得先讓他把話說完再收尾"
  }
};

/* ── 單一弱項 → 缺口說明 ──
   2026-09-08 老師拍板重寫：舊版四段全是「成交／掏錢／高單價」框架——
   ①quiz 訴求 0907 已從「變現」改「影響力」②選「職場與家人」場景的人讀到錢會出戲
   ③骨層三問第 2 問：皮層句不得獨自站著。錢的果實句留給健身房層。 */
var WEAK_DESC = {
  A: "吸引肌肉是影響力的入口——他還沒想靠近你，你說得再好，後面的信任、專業、推進都輪不到上場。\n\n你需要的不是更用力講，是讓人自然想靠近你、想聽你說下去。",
  T: "信任肌肉是地基——他可能覺得你厲害，但真心話還留著，最重要的事不會跟你說。\n\n你需要的不是講更多，是讓他覺得「你真的懂我」——心打開了，話才進得去。",
  P: "專業肌肉決定他會不會指名找你——他說「聽起來不錯」，但還不確定你能不能解決他的問題，就會回去想想，然後沒有然後。\n\n你需要的是把你的本事，用他聽得懂的話說出來，讓他認定「這要問你」。",
  I: "推進肌肉是臨門一腳——前面都做對了，他也心動了，但最後還是「我再想想」。\n\n你需要的是在對的時機，給他一個現在就動的理由，而不是等他自己決定。"
};
